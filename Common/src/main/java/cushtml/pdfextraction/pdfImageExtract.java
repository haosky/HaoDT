...
public class pdfImageExtract
{
    public static void main(String[] args) throws IOException
    {
        ...
        try (PDDocument doc = PDDocument.load(file))
        {
            ...
            ImageIO.write(image, "PNG", new File("D:\\tmp\\ll\\custom-render.png"));
        }
    }
    ...
    private static class MyPageDrawer extends PageDrawer
    {
                                 ...
                                 Vector displacement) throws IOException
        {
            ...
            graphics.setClip(clip);// draw
            graphics.setClip(graphics.getDeviceConfiguration().getBounds().intersection(new Rectangle(10, 10, 10, 10)));
