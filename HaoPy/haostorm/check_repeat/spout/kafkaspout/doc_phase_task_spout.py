...
__author__ = 'hao'
log = getlog(fileName="doc_phase_task_spout.log",loggerMain='doc_phase_task_spout')
pass_obj = namedtuple("kaphase","key value")
'''拉取kafka获取文章断落列表'''


class doc_phase_task_spout(Spout):
    # 定义输出结构
    ...
    def init(self):
        ...
        self.balanced_consumer =self.phase2kafka.consumer_es_search_task_doc()
